...
def openwindow():
    ...
    def Save_file():
        ...
        df = pd.DataFrame()
        #df['ELEMENTOS INORGANICOS'] = listaobjeto[0::2]
        #df['ELEMENTOS ORGANICOS'] = listaobjeto2[1::2]
    ...
    def VerificarVAlores():
        ...
        if ((EntVariable1.get() == "") or (EntVariable1.get() == "") or (EntVariable1.get() == "")
                or (EntVariable1.get() == "") or (EntVariable1.get() == "") or (EntVariable1.get() == "") or (
                        EntVariable1.get() == "") or
                (EntVariable1.get() == "")):
            messagebox.showwarning('CAUTION ', 'No se puede ejecutar el programa si no hay valores de entrada')
        else:
            Total1 = float(EntVariable1.get()) + float(EntVariable2.get()) + float(EntVariable3.get()) + float(
                EntVariable4.get())
            Total2 = float(EntVariable5.get()) + float(EntVariable6.get()) + float(EntVariable7.get()) + float(
                EntVariable8.get())
